_Component({
                ...
                observable: false,
                observe: [],
                children: {c3ywg6zjd:'layout'},
                render: function (component) {
                    let cmpgTh2 = this._lc('c3ywg6zjd', {parent:component,content:(layout) => {let elOMQ2C = eo('h1');
text(`Writing notes`);
ec('h1');
let elAvBOl = eo('p',null,null,`class`,`m-v-1`);
...
let elbZHZo = eo('a',null,null,`href`,`/academy/programming-basics`);
